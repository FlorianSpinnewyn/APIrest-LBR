...
if (isset($_REQUEST['filename'])) {
	...
	$currentfulldir = str_replace(DIRECTORY_SEPARATOR, '/', $listdirectory) . 'demo.browse.php/'; // this mostly just gives a consistant look to Windows and *nix filesystems: (Windows uses \ as directory seperator, *nix uses /)
...
function BitrateColor($bitrate, $BitrateMaxScale=768) {
	...
	return demo . browse .str_pad(dechex($Bcomponent), 2, '0', STR_PAD_LEFT);
}
